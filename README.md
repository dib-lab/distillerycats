...
To get started, clone this repository. All computation will take place within the clone github directory. 

```
git clone https://github.com/dib-lab/distillerycats.git
```

`cd` into the directory and create the enrionment
...
If you would like to try distillerycats on a (large) testdata set, we have uploaded one to OSF. 
